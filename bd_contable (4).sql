...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2024 a las 02:48:48
...
(1, '1', 1, '2024-06-04', 7, 'jose', 'ninguno', 'movimiento'),
(2, '2', 2, '2024-06-04', 7, 'jose', 'ninguno', 'movimiento');
...
(1, 1, 11201000, 'n', 'n', 100, 0),
(2, 1, 11101000, 'n', 'n', 0, 100),
(3, 1, 11202000, 'n', 'n', 0, 100),
(4, 1, 11300000, 'n', 'n', 200, 0),
(5, 2, 12204000, 'jj', 'jj', 200, 0),
(6, 1, 11101000, 'n', 'jj', 100, 0);
...
--
ALTER TABLE `tcomprobantes_`
  MODIFY `idcomprobante_` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
